...
use gpui::{canvas, ElementId, Empty, IntoElement, div, InteractiveElement, ParentElement, Render, Window, Context, SharedString, Styled, StatefulInteractiveElement, AppContext};
use smol::stream::StreamExt;
use crate::button::Button;
use crate::{v_flex, ActiveTheme, IconName, Sizable};
...
fn debug_wrap(id: impl Into<ElementId>, selector: String, child: Button) -> impl IntoElement {
...
impl Render for Pane {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        for ix in 0..tab_count {
            ...
            let close_ib = Button::new(("pane-tab-close", tab_id.0))
                .icon(IconName::Close)
                .small()
                .bg(cx.theme().muted)
                .aspect_square()
        ...
        tab_bar = tab_bar.child(debug_wrap(
            "pane-add-tab-wrap",
            "PANE-ADD-TAB".to_string(),
            Button::new("pane-add-tab",).icon(IconName::Plus)
                .small()
        ...
        tab_bar = tab_bar.child(debug_wrap(
            ...
            Button::new("pane-close",).icon(IconName::Close)
                .small()
