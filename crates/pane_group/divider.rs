...
use gpui::{px, Axis, Context, DragMoveEvent, Empty, Pixels, Window, AppContext, IntoElement};
use crate::resizable::ResizeHandle;
use super::PaneGroup;
...
impl PaneGroup {
    ...
    pub(super) fn render_divider(
        ...
        ResizeHandle::new(format!("pane-divider-{path:?}-{handle_ix}"),axis)
            // .axis(axis)
